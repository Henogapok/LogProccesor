...
public class ProcessLogFileCommandHandler : IRequestHandler<ProcessLogFileCommandV2, LogReport>
{
    public async Task<LogReport> Handle(ProcessLogFileCommandV2 request, CancellationToken cancellationToken)
    {
