...
public class ProcessLocalLogFileCommandHandlerV1 : IRequestHandler<ProcessLocalLogFileCommand, LogReport>
{
    public async Task<LogReport> Handle(ProcessLocalLogFileCommand request, CancellationToken cancellationToken)
    {
